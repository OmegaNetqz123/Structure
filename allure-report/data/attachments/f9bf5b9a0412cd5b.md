...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <div class="popupProcessing">…</div> intercepts pointer events
    ...
    4 × waiting for element to be visible, enabled and stable
      ...
      - scrolling into view if needed
      - done scrolling
      - <div id="columns-orderchange" class="case-searchmain open-canvas">…</div> from <div class="edicaserowmaster">…</div> subtree intercepts pointer events
    - retrying click action
      - waiting 500ms
